...
#SBATCH --output=../cache/04_pilon2slurm.out
...
########################################
ref=${mypath}/cache/03_${out}.${asm_version}.pilon1/03_${out}.${asm_version}.p1.fasta
outdir=cache/04_${out}.${asm_version}.pilon2

if [ ! -f $outdir ]; then
	mkdir $outdir
fi

pilonJar=$mypath/lib/pilon.jar
refname=$(basename $ref)
out_prefix=04_${out}.${asm_version}.p2
